...
var __ = {
  merge: function merge(def, overwriter) {
    if (_.isString(def)) {
  ...
  */
  ...
  array: {
    /*
        ...
        >> [one, 2, false, false]
    */
    merge: function merge(def, overwriter, length) {
      var arrayLength = 4;
      ...
      return _.map(_.fill(Array(arrayLength), false), function (line, i) {
        if (!overwriter) {
          return def[i];
        }
  ...
  object: {
     ...
     */
    merge: function merge(def, overwriter) {
      return _.assignIn({}, def, overwriter);
    }
  }
};
module.exports = __;